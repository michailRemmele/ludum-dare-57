...
export const EngineContext = React.createContext<EngineContextProps>({} as EngineContextProps);

export const EngineProvider: FC<EngineProviderProps> = ({ uiOptions, children }): JSX.Element => {
