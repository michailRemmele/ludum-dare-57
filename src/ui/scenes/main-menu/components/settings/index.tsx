...
import { getAudioVolume, saveAudioVolume } from '../../../../../utils/audio-settings';
...
export const Settings: FC<SettingsProps> = ({ openMenu }) => {
  ...
  const handleMasterVolumeChange = (value: number): void => handleVolumeChange('master', value);
  const handleMusicVolumeChange = (value: number): void => handleVolumeChange('music', value);
  ...
  return (
    <div className="settings-menu">
      ...
      <Button className="settings-menu__button" onClick={handleBack}>Back</Button>
    </div>
  );
};
