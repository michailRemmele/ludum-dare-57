...
export class ControlStickScript extends Behavior {
  private actor: Actor;
  private scene: Scene;
  ...
  constructor(options: BehaviorOptions) {
    ...
    this.scene.addEventListener(EventType.ControlStickInput, this.handleControlStickInput);
  }

  destroy(): void {
    this.scene.removeEventListener(EventType.ControlStickInput, this.handleControlStickInput);
  }
