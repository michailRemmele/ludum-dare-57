...
import ShoalUnit from '../../components/shoal-unit/shoal-unit.component';
import Shoal from '../../components/shoal/shoal.component';
...
export default class FishBehavior extends Behavior {
  private actor: Actor;
  private scene: Scene;
