...
export default class CameraBehavior extends Behavior {
  ...
  private updateBorders(): void {
    ...
    const leftCollider = this.leftBorder.getComponent(Collider);
    const rightCollider = this.rightBorder.getComponent(Collider);
    const topCollider = this.topBorder.getComponent(Collider);
    const bottomCollider = this.bottomBorder.getComponent(Collider);
